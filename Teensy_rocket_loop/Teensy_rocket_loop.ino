...
#define STEPS_PER_FILTER 33  // Six filter over 200 steps gives 33 steps per filter

const int STEPPER_PIN_IN1A = 34;  // Make sure to double check with these.
...
void setup() {
  ...
  samplerStepper.setSpeed(STEPPER_SPEED);
